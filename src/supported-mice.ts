...
export const MICE: Mouse[] = [
  ...
  { brand: "Attack Shark", model: "X11",                status: "likely",    req: 10,
    note: "0x25a7 GearHub protocol — needs hardware test; the 0x1d57 variant (0xfa55/0xfa60) exposes no control interface to the browser" },
  ...
  { brand: "Attack Shark", model: "R1",                 status: "likely",    req: 3,
    note: "0x1d57 family — needs hardware test; the X11 on this VID exposes no control interface to the browser" },
